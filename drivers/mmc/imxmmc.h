...
# define IMX_MMC_BASE IMX_SDHC1_BASE
...
#  define CLK_RATE_CLK_RATE(x)            (((x) & 0xfff) << 4)
#endif /* defined(CONFIG_ARCH_IMX21) */
...
#  define CMD_DAT_CONT_RESPONSE_FORMAT_R2 (2)
#  define CMD_DAT_CONT_RESPONSE_FORMAT_R3 (3)
#  define CMD_DAT_CONT_RESPONSE_FORMAT_R4 (3)
#  define CMD_DAT_CONT_RESPONSE_FORMAT_R5 (1)
#  define CMD_DAT_CONT_RESPONSE_FORMAT_R6 (1)
#endif /* defined(CONFIG_ARCH_IMX21) */
#if defined(CONFIG_ARCH_IMX)
