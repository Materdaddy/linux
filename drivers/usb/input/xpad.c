 ...
 *
 * 2008-04-14 - 0.0.7 : Added Konami Dancepad
 *  - includes modified to compile with 2.6.16 kernel
 *
 */
...
#define XBOX360_SUPPORTED
#undef XBOX360_SUPPORTED /* henry@chumby.com - not supported with 2.6.16 kernel */
...
static const struct xpad_device {
        ...
        { 0x12ab, 0x0004, "Konami Dance Pad", MAP_DPAD_TO_BUTTONS, XTYPE_XBOX },
...
#ifdef XBOX360_SUPPORTED
        { USB_DEVICE_INTERFACE_PROTOCOL(0x045e, 0x028e, 1) },   /* X-Box 360 controller */
#endif
		{ USB_DEVICE( 0x12ab, 0x0004 ) }, /* Konami dancepad needs to be explicitly included here */
        { }
};
