...
/* -------------------- Set Hardware Capabilities for MX21 ADS --------------- */

#elif defined(CONFIG_MACH_MX21ADS)
#include <asm/arch/mx21ads.h>
#define CIRRUS_IOADDR			(MX21ADS_ETH_VIRT + 0x300)
#define CIRRUS_IRQ			MX21ADS_ETH_IRQ
...
/* -------------------- Set Hardware Capabilities for TCMX21 --------------- */

#elif defined(CONFIG_MACH_TCMX21)
#include <asm/arch/tcmx21.h>
#define CIRRUS_IOADDR			(TCMX21_ETH_VIRT + 0x300)
#define CIRRUS_IRQ			TCMX21_ETH_IRQ
